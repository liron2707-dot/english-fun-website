...
# ==========================================
PRIZE_IMAGES = {
    " 🍦   גלידת   קצפת   ענקית ": "https://upload.wikimedia.org/wikipedia/commons/2/2e/Ice_cream_with_whipped_cream%2C_chocolate_syrup%2C_and_a_wafer.jpg",
    " 🐉   דרקון   אש   חמוד ": "https://upload.wikimedia.org/wikipedia/commons/d/d4/Chinese_dragon_in_Sydney.jpg",
    ...
    " ⚽   חפיסת   קלפי   מסי   זהב ": "https://upload.wikimedia.org/wikipedia/commons/b/b4/Lionel-Messi-Argentina-2022-FIFA-World-Cup_%28cropped%29.jpg",
    " 🏆   קלף   רונאלד ו נדיר": "https://upload.wikimedia.org/wikipedia/commons/8/8c/Cristiano_Ronaldo_2018.jpg",
    " 🎧   אוזניות   אפל  Airpods": "https://upload.wikimedia.org/wikipedia/commons/c/ce/Apple_AirPods_Pro.jpg",
    " 🌟   מארז   קלפי   כדורגל ": "https://upload.wikimedia.org/wikipedia/commons/d/d3/Soccerball.svg",
    " 🤖   רובוט   אינטראקטיבי ": "https://upload.wikimedia.org/wikipedia/commons/b/b6/Robot_icon.png",
    " 💻   מחשב   גיימינג   מפלצתי ": "https://upload.wikimedia.org/wikipedia/commons/a/a2/Personal_computer%2C_tower_case.png",
    " 📱   אייפון  15  פרו   מקס ": "https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg",
    " 🛹   הוברבורד   חשמלי ": "https://upload.wikimedia.org/wikipedia/commons/0/0f/Hoverboard.jpg",
    " 🎮   סוני   פלייסטיישן  5": "https://upload.wikimedia.org/wikipedia/commons/3/39/PS5_logo.svg",
    " 🥽   משקפי   מציאות   מדומה  VR": "https://upload.wikimedia.org/wikipedia/commons/3/3a/VR_logo.png",
    " 🦸‍♂️   קלף   ספיידרמן   נדיר ": "https://upload.wikimedia.org/wikipedia/commons/0/07/Spiderman-Icon.png",
    " ⚔️   חרב   נינג ' ה   זוהרת ": "https://upload.wikimedia.org/wikipedia/commons/a/af/Ninja_sword_icon.png",
    " 🦄   בובת   חד   קרן   ענקית ": "https://upload.wikimedia.org/wikipedia/commons/8/85/Unicorn-icon.png",
    " 🛸   רחפן   צילום   מקצועי ": "https://upload.wikimedia.org/wikipedia/commons/4/43/Drone_icon.png",
    " 🏎️   מכונית   על   למבורגיני ": "https://upload.wikimedia.org/wikipedia/commons/4/45/Lamborghini_logo.png",
    " 🪄   שרביט   קסמים   אמיתי ": "https://upload.wikimedia.org/wikipedia/commons/f/f6/Magic_wand_icon.png",
    " 👑   כתר   יהלומים ": "https://upload.wikimedia.org/wikipedia/commons/6/6f/Crown_icon.png",
    " 💎   תיבת   אוצר   מסתורית ": "https://upload.wikimedia.org/wikipedia/commons/a/af/Treasure_chest_open_icon.svg"
}
...
# ==========================================
    ...
    with st.sidebar:
        ...
        st.markdown("<p style='text-align: center; font-size: 12px; color: green;'>✅ נשמר אוטומטית בענן</p>", unsafe_allow_html=True)
        st.markdown(f"""
        <div class="stats-bar">
        ...
        if st.button(" 💼   אלבום   הקלפים   והכספת   שלי !", type="primary", use_container_width=True):
            ...
            st.rerun()
        if st.button(" 🚪   התנתק (המשחק שומר את עצמו)", use_container_width=True):
            sync_data()
